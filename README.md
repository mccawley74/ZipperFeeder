...
3. The amount of food it dispenses is based on the Auger size. I included two:
    - auger_larger.stl Has larger spacing, allowing more food per rotation.
...
4. Hard to assemble due to small size. 5. Manual alignment of the Auger. Only needs done once. Could be added to code (Have a go!) 6. Some manual modifications needed. I.e OLED mounting, button location and hole, screw
choice.

7. No screw standard. I used what I had, what fit. The front cover is pass-through (Nut bolt) The rear cover and motor cover/motor mounting is
self threading screws.

8. NOT battery powered, needs USB 5v

NO: It does not overheat in such a small space. It really doesn\'t do anything until it feeds. The motor is external of the main chassis, runs only every 3 hours minimum, etc\... There is however a vented front cover \"front_cover_vented.stl\" if you are paranoid.


## BOM Item Description Cost
...
rectangle shape.
![motor-control-boards_x.png](Images/motor-control-boards_x.png)
...
If you use the smaller rectangle shaped motor control board it
...
---
There is no clock in the Arduino Pro Micro, so
...
Interval Feed at night | 6 Hour | False |
- Food rotations will be 9:00am , 3:00pm

Interval Feed at night | 3 Hour | False
- Food rotations will be: 9:00am , 12:00pm , 3:00pm , 6:00pm

Interval Feed at night | 3 Hour | True
